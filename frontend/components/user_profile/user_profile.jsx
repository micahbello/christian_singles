...
// //
  ...
  likeIcon () {
    ...
    if (this.props.currentUser.id === this.props.currentProfile.id) {
      ...
      <div className="heart-circle">
        <i className="fas fa-heart fa-2x" onClick={(e) => this.deleteLikeIcon(e)}></i>
      </div>
      )
    } else {
      return (
  ...
  deleteLikeIcon(e) {
    $(e.target).attr("id", " ");
    this.props.deleteLike(this.props.currentUser.id, this.props.currentProfile.id);
  }
              ...
              <section className="user-profile-pic-info-container">
                ...
                <section className="profile-info-container">
                    ...
                    <section className={this.props.currentUser.id === this.props.currentProfile.id
                      ...
                      <i className="fas fa-bullseye"></i><h3>Match Summary</h3>
